...
exports.createEventToolSchema = void 0;
...
exports.createEventToolSchema = {
    ...
    is_online_meeting: zod_1.z.boolean()
        .default(true)
    ...
    is_recurring: zod_1.z.boolean()
        .default(false)
        .describe("Whether this is a recurring event. Example: true for weekly team meetings"),
    recurrence_type: zod_1.z.enum(['daily', 'weekly', 'monthly', 'yearly', 'absoluteMonthly', 'relativeMonthly', 'absoluteYearly', 'relativeYearly'])
        .optional()
        .describe("The type of recurrence. Example: 'daily', 'weekly', 'monthly', 'relativeMonthly'"),
    days_of_week: zod_1.z.array(zod_1.z.enum(['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday']))
        .default(['monday', 'wednesday', 'friday'])
        .optional()
        .describe('Days of the week for weekly recurrence. Example: ["monday", "wednesday", "friday"]'),
    recurrence_interval: zod_1.z.number()
        .int()
        .positive()
        .default(1)
        .optional()
        .describe("The interval between occurrences. Example: 2 for every other week/month"),
    recurrence_range_type: zod_1.z.enum(['endDate', 'noEnd', 'numbered'])
        .default('endDate')
        .optional()
    ...
    recurrence_end_date: zod_1.z.string()
        .default(() => {
        const date = new Date();
    ...
    recurrence_occurrences: zod_1.z.number()
        .int()
        .positive()
        .default(10)
        .optional()
